...
fig
save(joinpath(fig_path, "sfigure_murphy.pdf"), fig) #src
@test_reference joinpath(fig_path, "sfigure_murphy.png") fig #src
...
resize_to_layout!(fig)
fig
save(joinpath(fig_path, "sfigure_murphy_2.pdf"), fig) #src
@test_reference joinpath(fig_path, "sfigure_murphy_2.png") fig #src
