...
eql_sol = stepwise_selection(esol; diffusion_basis, reaction_basis,
    ...
    mesh_points=100,
    num_knots=50, threshold_tol=(q=0.0, dt=0.4),
...
eql_sol_3 = stepwise_selection(esol; diffusion_basis, reaction_basis,
    ...
    threshold_tol=(dx_bc=0.0, dL=0.0), initial=:none,
...
eql_sol_4 = stepwise_selection(esol; diffusion_basis, reaction_basis,
    ...
    num_knots=100,
    threshold_tol=(dL=0.0, dx_bc=0.0, q=0.3, dx=0.0, dt=0.00),
...
ax_dq = Axis(fig[2, 1],
    ...
    yticks=(0.0005:0.0025:0.005, [L"%$s" for s in 0.0005:0.0025:0.005])
)
q_min, q_max = extrema(stack(eql_sol_4.model.cell_sol.q))
q_min = 5
xlims!(ax_dq, q_min, q_max)
ylims!(ax_dq, 0.0005, 0.005)
ax_rq = Axis(fig[2, 2],
...
hlines!(ax_rq, [0.0], linecolor=:grey, linewidth=3, linestyle=:dash)
